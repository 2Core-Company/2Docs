            ...
            <div className={`w-[80px] fixed max-sm:max-w-[70px] h-full  ${menu ? "max-lg:left-[-150px]" : "flex"} left-0 duration-300 flex flex-col items-center border-r-2 border-terciary`}> 
                <Tooltip.Provider delayDuration={1000} skipDelayDuration={500}>
                    <Tooltip.Root>
                        ...
                        <Tooltip.Portal>
                            <Tooltip.Content  side="right" sideOffset={10}>
                                <p className='ml-[2px] text-[18px] font-[500] text-white dark:text-black px-[5px] rounded-[10px] bg-gray-700 dark:bg-gray-200'>Foto de Perfil</p>
                                {theme == "light" ? (
                    ...
                    <Tooltip.Root>
                        ...
                        <Tooltip.Portal>
                            <Tooltip.Content  side="right" sideOffset={10}>
                                <p className='ml-[2px] text-[18px] font-[500] text-white dark:text-black px-[5px] rounded-[10px] bg-gray-700 dark:bg-gray-200'>Pagina Inicial</p>
                                {theme == "light" ? (
                                    <Tooltip.Arrow width={15} height={10} className='fill-gray-700'/>
                                ) : (
                                    <Tooltip.Arrow width={15} height={10} className='fill-gray-200'/>
                    ...
                    {props.user === "Clients" ? 
                        <Tooltip.Root>
                            ...
                            <Tooltip.Portal>
                                <Tooltip.Content  side="right" sideOffset={10}>
                                    <p className='ml-[2px] text-[18px] font-[500] text-white dark:text-black px-[5px] rounded-[10px] bg-gray-700 dark:bg-gray-200'>Arquivos</p>
                                    {theme == "light" ? (
                                        <Tooltip.Arrow width={15} height={10} className='fill-gray-700'/>
                                    ) : (
                                        <Tooltip.Arrow width={15} height={10} className='fill-gray-200'/>
                    ...
                    :
                        <Tooltip.Root>
                            ...
                            <Tooltip.Portal>
                                <Tooltip.Content  side="right" sideOffset={10}>
                                    <p className='ml-[5px] text-[20px] font-[500] text-white dark:text-black px-[5px] rounded-[10px] bg-gray-700 dark:bg-gray-200'>Clientes</p>
                                    {theme == "light" ? (
                                        <Tooltip.Arrow width={15} height={10} className='fill-gray-700' />
                                    ) : (
                                        <Tooltip.Arrow width={15} height={10} className='fill-gray-200' />
                    ...
                    <Tooltip.Root>
                        ...
                        <Tooltip.Portal>
                        <Tooltip.Content  side="right" sideOffset={10}>
                            <p className='ml-[2px] text-[18px] font-[500] px-[5px] rounded-[10px] bg-red text-white'>Sair</p>
