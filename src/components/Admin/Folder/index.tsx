...
function ComponentFolder() {
  ...
  return (
    <div className="mt-[40px]">
      {/* {createFolder && <CreateFolder id_company={dataAdmin.id_company} enterprise={enterprise} id={id_user} user={user} setCreateFolder={setCreateFolder} setUser={setUser} /> }

{folderConfig.status && <FolderConfig user={user} enterprise={enterprise} id={id_user} id_company={dataAdmin.id_company} setFolderConfig={setFolderConfig} folderConfig={folderConfig} setUser={setUser} setEnterprise={setEnterprise} />}
...
{modal.status && <ModalDelete modal={modal} setModal={setModal} childModal={childModal} />} */}
      ...
      <div className="flex items-center text-[#AAAAAA] text-[18px] max-sm:text-[16px] mt-[5px]">
        ...
        <Image src={'/icons/folder.svg'} priority width={15} height={15} alt='' className='mr-[5px]' />
        <p>Pastas</p>
      </div>

      {user.enterprises[0] && <Enterprises user={user} setUser={setUser} />}
