...
export const companyContext = createContext<{dataCompany:DataCompanyContext, setDataCompany:Function}>
({dataCompany:{contact:[], questions:[], gbFiles:{type:"", size:0, porcentage:0}, plan:{maxSize:0}}, setDataCompany:(dataCompany) => {}});
